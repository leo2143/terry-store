<section class="container">
  <div id="home" class="home-container container-fluid d-flex align-items-center py-4 rounded-3 ">

    <div class="container ">
      <div class="row g-4 justify-content-center align-items-center">

        <div class="col-12 d-md-none order-1 text-center">
          <h1 class="display-3 mb-3">¡Bienvenido viajero!</h1>
        </div>

        <div class="col-12 col-md-6 order-3 order-md-1 text-center text-md-end pe-md-4 position-relative terry-image-container">
          <img class="img-fluid terry-image" alt="terry" src="images/terry-large.png">
        </div>

        <div class="col-12 col-md-6 order-4 order-md-2 ps-md-4">
